---
title: "The thousand ways to hit someone"
lang: en
tags: [articulos, expresiones]
translationKey: "Artículos/Las miles de maneras de dar un golpe"
...
```mermaid
graph TD
    A["Una catimba or una pela<br/>(a beating)"] --> B["Un barrecampo"]
    A --> C["Una galleta"]
    A --> D["Un puño en la cara<br/>(a punch in the face)"]
    A --> E["Una pescozá"]
    A --> F["Una gaznatá"]
```
